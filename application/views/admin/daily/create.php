<div class="col-md-7 mx-auto">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <?php
            echo form_open_multipart('admin/mobil/create_daily/' . $mobil->id . '/' . $kota->id);
            ?>
                ...
                foreach ($paket_daily as $paket) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- <a href="<?php echo base_url('admin/mobil/update_paket/' . $data->id); ?>" class="text-danger"><i class="far fa-times-circle"></i></a> -->
