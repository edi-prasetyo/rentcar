<div class="container my-2">
    <?php echo form_open('admin/admindaily/kendaraan/' . md5($kota_id), array('method' => 'get', 'class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                <label class="form-label">Pilih Kota</label>
                <select class="form-control select2bs4" name="kota_id" required>
