<div class="">
    <div class="container my-2">
        <?php echo form_open('admin/admindropoff/kendaraan/' . md5($kota_asal) . '/' . md5($kota_tujuan), array('method' => 'get', 'class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select class="form-control select2bs4" name="jam_sewa" value="" required>
                ...
                <div class="col-md-3 col-6 my-2">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <?php echo form_open('admin/admindropoff/order/', array('method' => 'get')); ?>
