<a href="#" class="text-success" data-toggle="modal" data-target="#Edit<?php echo $paket->id; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="paket_point" placeholder="Point" value="<?php echo $paket->paket_point; ?>">
