        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
                ...
                <div class="hit-a" style="display: none">
                    <?php echo form_open('admin/driver/tambah_saldo/' . $driver->id,  array('class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
                    <div class="form-group">
                ...
                <div class="hit-b" style="display: none">
                    <?php echo form_open('admin/driver/potong_saldo/' . $driver->id,  array('class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
