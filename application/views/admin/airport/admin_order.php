                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <i class="fas fa-car"></i> <?php echo $mobil_name; ?> <br>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open('admin/adminairport/order',  array('class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            <label>Termial Penjemputan <span class="text-danger">*</span>
                            </label>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="jam_jemput" class="form-control" value="<?php echo $jam_jemput; ?>" readonly>
