        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <?php $no = 1;
                    foreach ($paket_airport as $paket_airport) { ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo $paket_airport->paket_name; ?></td>
                            <td><?php echo $paket_airport->paket_price; ?></td>
                            <td><?php echo $paket_airport->paket_point; ?></td>
                            <td>
                                <a href="<?php echo base_url('admin/mobil/delete_airport/' . $paket_airport->id); ?>" class="text-danger"><i class="far fa-times-circle"></i></a>
