...
<div class="container my-2">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control form-control-lg" data-live-search="true" name="airport_id">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <select class="form-control form-control-lg" name="jam_jemput" value="" required>
    ...
    <div class="col-md-2">
        <div class="form-group">
            <button type="submit" class="btn btn-warning btn-lg btn-block">Cari Mobil</button>
        </div>
    </div>
</div>
