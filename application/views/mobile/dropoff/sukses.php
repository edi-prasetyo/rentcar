    ...
    <div class="col-md-9 mx-auto">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        Paket : <?php echo $transaksi->origin; ?> - <?php echo $transaksi->destination; ?><br>
                        Status Penggunaan :
        ...
        <?php else : ?>
            ...
            <div style="z-index: 9999;" class="carbook-menu-fotter fixed-bottom bg-white px-3 py-2 text-center shadow">
                <a href="<?php echo base_url('dropoff/payment/' . $transaksi->id); ?>" class="btn-order-block"> <i class="fa-solid fa-arrow-right"></i> Bayar Sekarang</a>
            </div>
        <?php endif; ?>
