...
<div class="container my-3 pb-5">
    ...
    <div class="col-12 mx-auto">
        <div class="card">
            <div class="card-body">
                <?php echo form_open('transaksi/create',  array('method' => 'get', 'class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="invalid-feedback">Silahkan Masukan Alamat Jemput</div>
                </div>
