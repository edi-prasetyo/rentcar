<div class="bg-primary">
    <div class="container my-2">
        ...
        <div class="container my-2">
            <?php echo form_open('hourly/kendaraan/' . md5($kota_id), array('method' => 'get')); ?>
            <div class="row">
                <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="booking-cta">
                <h1>Sewa Mobil Perjam</h1>
                <p>Sewa mobil Perjam adalah Layanan Sewa Mobil yang bisa anda gunakan untuk jangka per jam. ada banyak pilihan mobil dan juga pilihan kota yang tersedia.
                <p>
                    Kami menyediakan paket mulai dari 3 jam sampai 10 jam.Harga sudah termasuk driver, diluar biaya BBM, Toll Parkir dan Uang makan driver.
                </p>
                </p>
            </div>
        </div>
            ...
            <div class="col-md-3 col-6">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <?php echo form_open('hourly/paket/' . $kota_id . '/' . $data->mobil_id, array('method' => 'get')); ?>
