...
<section id="services" class="my-5">
    <div class="container">
        <h2 class="title my-5 text-center">Pilihan <span>Kota</span> Terpopuler</h2>
        <br>
        <div class="row">
            <div class="col-md-4">
                <div class="item e3">
                    <img src="<?php echo base_url('assets/img/galery/bg-jakarta.jpg'); ?>">
                    <div class="text3">
                        <h3>DKI Jakarta</h3>

                        <p>Temukan Harga Sewa Mobil Termurah di Jakarta<br><br>
                            <a href="<?php echo base_url(); ?>" class="btn btn-warning">Klik Disini </a>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="item e3">
                    <img src="<?php echo base_url('assets/img/galery/bg-tangerang.jpg'); ?>">
                    <div class="text3">
                        <h3>Tangerang</h3>

                        <p>Mau Jalan jalan di Tangerang pesen sewa mobil aja disini<br><br>
                            <a href="<?php echo base_url(); ?>" class="btn btn-warning">Klik Disini </a>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="item e3">
                    <img src="<?php echo base_url('assets/img/galery/bg-bogor.jpg'); ?>">
                    <div class="text3">
                        <h3>Bogor</h3>

                        <p>Mau sewa mobil di bogor dengan harga termurah<br><br>
                            <a href="<?php echo base_url(); ?>" class="btn btn-warning">Klik Disini </a>
                        </p>
                    </div>
                </div>
