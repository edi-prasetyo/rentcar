    ...
    <div class="row">
        <div class="col-md-6">
            <div class="booking-cta">
                <h1>Sewa Mobil Antar jemput Bandara</h1>
                <p>Sewa mobil Bandara adalah Layanan Sewa Mobil Antar jemput untuk area Banrdara ke kota tujuan atau sebaliknya.
                <p>
                    Untuk layanan Antar jemput Bandara hanya melayani untuk antar saja atau jemput saja
                </p>
                </p>
            </div>
        </div>
