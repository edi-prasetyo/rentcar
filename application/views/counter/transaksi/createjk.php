...
<?php echo form_open('counter/transaksi/createjk',  array('class' => 'needs-validation', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nomor HP <small class="text-success">(Boleh di kosongkan)</small> </label>
